...
const binSetValue = async (ID: ID, value: any, contentType: string|null, filename: string|null) => {
...
const binCreateBin = async (body: any, contentType: string|null, filename: string|null) => {
